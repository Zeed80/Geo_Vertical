...
class PointMapping:
    ...
    def add_mapping(self, table_row: int, data_index: Any, point_name: str | None = None):
        """
    ...
    def get_data_index(self, table_row: int) -> Any | None:
        """
    ...
    def get_table_row(self, data_index: Any) -> int | None:
        """
    ...
    def get_data_index_by_name(self, point_name: str) -> Any | None:
        """
    ...
    def get_point_name(self, data_index: Any) -> str | None:
        """
    ...
    def remove_mapping(self, table_row: int | None = None, data_index: Any | None = None):
        """
