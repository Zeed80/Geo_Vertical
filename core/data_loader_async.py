...
class DataLoadThread(QThread):
    ...
    data_loaded_detailed = pyqtSignal(object)  # LoadedSurveyData
    ...
    def run(self):
        ...
        try:
            ...
            loaded: LoadedSurveyData = load_survey_data(self.file_path)
            data, epsg_code = loaded.data, loaded.epsg_code
            ...
            self.data_loaded_detailed.emit(loaded)
            ...
            error_msg = f"Неожиданная ошибка при загрузке: {e!s}"
